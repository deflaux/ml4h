...
if __name__ == '__main__':
    ...
    if TRAIN_BASELINE_MODEL:
        ...
        _train_model(
            model=_get_pretest_baseline_model(False), tmaps_in=BASELINE_INPUT_TMAPS, tmaps_out=PRETEST_OUTPUT_TMAPS, model_id=BASELINE_MODEL_ID,
        )
    ...
    if TRAIN_HR_ACHIEVED_MODEL:
        ...
        _train_model(
            model=_get_pretest_model(False), tmaps_in=HR_ACHIEVED_INPUT_TMAPS, tmaps_out=HR_ACHIEVED_OUTPUT_TMAPS, model_id=HR_ACHIEVED_MODEL_ID,
        )
