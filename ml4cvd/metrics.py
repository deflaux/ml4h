...
def asymmetric_myocardium(y_true, y_pred):
    ...
    ce = -K.sum(ce, -1)
    top_over = (ce * K.maximum(myocardium_true, 0) * K.maximum(myocardium_true - myocardium_pred, 0.0)) / 6000.0
    top_under = (ce * K.maximum(myocardium_true, 0) * K.maximum(myocardium_pred - myocardium_true, 0.0)) / 16000.0
