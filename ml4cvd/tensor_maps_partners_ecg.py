...
def build_partners_tensor_maps(needed_tensor_maps: List[str]) -> Dict[str, TensorMap]:
    ...
    for needed_name in needed_tensor_maps:
        if needed_name == 'age_from_csv':
        ...
        elif needed_name == 'sex_from_wide_csv':
            ...
            name2tensormap[needed_name] = TensorMap('ecg_rest_raw', shape=(2500, 12), path_prefix=PARTNERS_PREFIX, tensor_from_file=tff, channel_map=ECG_REST_UKB_LEADS)
