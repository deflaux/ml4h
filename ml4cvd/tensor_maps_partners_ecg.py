...
TMAPS['partners_ecg_1250_pdf'] = TensorMap('ecg_rest_1250_pdf', shape=(None, 1250, 12), path_prefix=PARTNERS_PREFIX, tensor_from_file=make_voltage(population_normalize=1.0), channel_map={f'{lead}_pdf': i for lead, i in ECG_REST_AMP_LEADS.items()}, time_series_limit=0)
...
TMAPS['partners_ecg_2500_raw'] = TensorMap('ecg_rest_2500_raw', shape=(None, 2500, 12), path_prefix=PARTNERS_PREFIX, tensor_from_file=make_voltage(population_normalize=1.0), channel_map=ECG_REST_AMP_LEADS, time_series_limit=0)
TMAPS['partners_ecg_5000_raw'] = TensorMap('ecg_rest_5000_raw', shape=(None, 5000, 12), path_prefix=PARTNERS_PREFIX, tensor_from_file=make_voltage(population_normalize=1.0), channel_map=ECG_REST_AMP_LEADS, time_series_limit=0)
