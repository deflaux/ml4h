...
from ml4cvd.metrics import weighted_crossentropy, ignore_zeros_logcosh, y_true_times_mse, y_true_squared_times_mse
from ml4cvd.metrics import y_true_cubed_times_mse, y_true_squared_times_logcosh, asymmetric_logcosh, asymmetric_mse, asymmetric_outlier_mse
...
TMAPS['adjusted_myocardium_mass_asymmetric'] = TensorMap('adjusted_myocardium_mass', Interpretation.CONTINUOUS, validator=make_range_validator(0, 400), path_prefix='continuous',
                                                  loss=asymmetric_logcosh, channel_map={'adjusted_myocardium_mass': 0}, normalization={'mean': 89.70, 'std': 24.80})
TMAPS['adjusted_myocardium_mass_asymmetric_mse'] = TensorMap('adjusted_myocardium_mass', Interpretation.CONTINUOUS, validator=make_range_validator(0, 400), path_prefix='continuous',
                                                  loss=asymmetric_mse, channel_map={'adjusted_myocardium_mass': 0}, normalization={'mean': 89.70, 'std': 24.80})
