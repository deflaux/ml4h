...
phenos = or_dic['50_hrr_downsample_augment_prediction'].keys()
...
# %%
dis_plot_list = disease_list
phenos = hr_dic['50_hrr_downsample_augment_prediction'].keys()
for dis, dis_label in disease_list:
    for occ in ['incident']:
        hrs = []
        cis_minus = []
...
for pheno in ['50_hrr_downsample_augment_prediction']:
...
import matplotlib
dis_plot_list = disease_list
phenos = or_multi_dic['50_hrr_downsample_augment_prediction'].keys()
for dis, dis_label in disease_list:
    for occ in ['prevalent']: 
        ors = []
        cis_minus = []
