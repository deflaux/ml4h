...
def plot_or_hr(or_dic, label_dic, disease_list, suffix, occ='prevalent', horizontal_line_y=None):
    ...
    for dis, dis_label in disease_list:
        ...
        ax.set_xticks([0.25, 0.5, 0.8, 1.0, 1.25, 2.0, 4.0, 8.0])
        ax.set_xticklabels(map(str, [0.25, 0.5, 0.8, 1.0, 1.25, 2.0, 4.0, 8.0]))
        ...
        ax.set_xlim([min(0.8, min(ors)*0.8), max(1.25, max(ors)*1.25)])
        plt.tight_layout()
