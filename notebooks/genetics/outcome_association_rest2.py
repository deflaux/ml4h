...
all_ecgs = pretest_to_rest
all_ecgs['50_hrr_downsample_augment_prediction'] = np.median(all_ecgs[[f'50_hrr_downsample_augment_split_{i}_prediction' for i in range(5)]], axis=1)
# %%
%matplotlib inline
